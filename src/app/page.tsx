...
function Navbar({ isSignedIn }: { isSignedIn: boolean }) {
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-slate-100">
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-medium leading-none text-purple-600">
          ...
          <div className="flex items-center gap-3">
            {isSignedIn ? (
              ...
              <>
                <Link
                  href="/sign-in"
                  className="px-4 py-2 rounded-xl text-sm font-semibold text-purple-700 border border-purple-300 hover:bg-purple-50 transition-all"
                >
                  Sign In
                </Link>
                <Link
